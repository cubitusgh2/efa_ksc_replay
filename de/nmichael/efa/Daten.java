...
public class Daten {
    ...
    public final static String VERSION            = "2.3.0_dev_SGB_TblPck,ListFilter+Focus,Sync+Config+Fullsync,LogRotate,ToFrontFix,FilterFix,SyncRefactor,SyncLessWarn,SyncVerbose,Look,Bulletfix,ListFix2_CSVExport,FilterDropDownV3,TooltipC,filterhighlight,prettybulletfix,ttcommentfix,filterotherboatfix,clubworkexportV3,weeklyres,resBoatlist,resBoatPerformanceFixv2,efbsyncunknownboats,limitedweeklyv5,exceptfix,perffixv2,resOnetimeDate,todaysreservationsFilter,efbsync_unknownboatlesslogging,resTodayFix,btlistexeptfix,restodayCache,exfixv8,tooltipfix,clearfilterfix,csvfix,autocompletefix,sortfix,efaconfigrefactor,boatrescopy"; // Version für die Ausgabe (z.B. 2.1.0, kann aber auch Zusätze wie "alpha" o.ä. enthalten)
    ...
    public final static String VERSIONRELEASEDATE = "04.10.2023";  // Release Date: TT.MM.JJJJ
