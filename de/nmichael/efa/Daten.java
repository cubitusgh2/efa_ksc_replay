...
public class Daten {
    ...
    public final static String VERSION            = "2.3.0_dev_SGB_TablePack,ListFilter+FilterFocus,Sync+Config+Fullsync,LogRotate,ToFrontFix,FilterFix,SyncRefactor,Look_20220618"; // Version für die Ausgabe (z.B. 2.1.0, kann aber auch Zusätze wie "alpha" o.ä. enthalten)
    ...
    public final static String VERSIONRELEASEDATE = "18.06.2022";  // Release Date: TT.MM.JJJJ
