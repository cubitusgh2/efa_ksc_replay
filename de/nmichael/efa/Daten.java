...
public class Daten {
	...
	public final static String VERSION = "2.4.1_ksc_BoatResSortV3,IconsV2,DebugVersion,ObsoleteReserv"; // Version für die Ausgabe (z.B. 2.1.0, kann aber
																	// auch Zusätze wie "alpha" o.ä. enthalten)
	public final static String VERSIONID = "2.4.1_#2"; // VersionsID: Format: "X.Y.Z_MM"; final-Version z.B. 1.4.0_00; beta z.B. 1.4.0_#1
	public final static String VERSIONRELEASEDATE = "26.05.2024"; // Release Date: TT.MM.JJJJ
