...
public class Daten {
    ...
    public final static String VERSION            = "2.4.0_00_0_dev_ListFix2_CSVExport,clubwrkexpV3,clearfilterfix,csvfix,EFA_057_LAF_11_startupfix3_ellipsisfix,autocompletefix"; // Version für die Ausgabe (z.B. 2.1.0, kann aber auch Zusätze wie "alpha" o.ä. enthalten)
    public final static String VERSIONID          = "2.4.0_.5";   // VersionsID: Format: "X.Y.Z_MM"; final-Version z.B. 1.4.0_00; beta-Version z.B. 1.4.0_#1
