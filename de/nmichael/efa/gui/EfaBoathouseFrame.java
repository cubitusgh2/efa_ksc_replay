...
/*        } else {
        	...
        	startSessionButtonMultiple.setVisible(false);
        }
*/
        centerPanel.add(finishSessionButton, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 0, 0, 0), 0, 0));
...
/*        } else {
        	  ...
        	  lateEntryButtonMultiple.setVisible(false);
        }
 */       
        //centerPanel.add(lateEntryButton, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(10, 0, 0, 0), 0, 0));
...
//        }
    ...
    void actionStartSessionMultiple() {
    	alive();
    	clearAllPopups();
        if (Daten.project == null) {
            return;
